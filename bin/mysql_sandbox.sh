...
make_sandbox $BUILD_DIR/mysql-* -- --force --bind_address=0.0.0.0 --no_confirm --db_user=$MYSQL_USER --db_password=$MYSQL_PASS --sandbox_port=$MYSQL_PORT --master --my_clause=binlog_format=row --my_clause=expire_logs_days=1
